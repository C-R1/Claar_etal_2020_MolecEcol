...
phylo1 <- phyASV.sym.Porites
phylo2 <- phyASV.mic.Porites

# Set filenames
FILE <- "figures/Figure_5/procrustes_plot_Porites.jpg"
FILE2 <- "figures/Figure_5/procrustes_plot_Porites.pdf"
...
pro.plot.Por <- ggplot(pro.p) +
  ...
  scale_color_manual(values="#49FF00",labels=c("P. lobata"))
...
# Save
save(pro.plot.Por,file="figures/Figure_5/procrustes_plot_Porites.RData")